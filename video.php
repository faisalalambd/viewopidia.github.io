    ...
    <section class="section">
        <div class="row ">
            <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-statistic-4" style="margin-right: 1rem;">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 pt-3">
                                            <div class="card-content">
                                                <article class="col-md-12 col-sm-12 col-xs-12 portfolio-item apps">
                                                    ...
                                                    <h5 class="project-title" style="margin-top: 1rem; font-size: 1rem;"><a href="video.php?id=<?php echo $row['id'] ?>"><?php echo $row['title'] ?></a></h5>
                                                </article>
                                            </div>
                                        </div>
                                        <?php if ($count % 4 == 0) { ?>
